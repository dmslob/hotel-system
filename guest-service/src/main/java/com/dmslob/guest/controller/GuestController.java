package com.dmslob.guest.controller;

import com.dmslob.guest.model.Guest;
import com.dmslob.guest.repo.GuestRepository;
...
public class GuestController {
    ...
    public List<Guest> getGuests(@RequestParam(name = "emailAddress", required = false) String emailAddress) {
    ...
    public Guest getById(@PathVariable(name = "id") long id) {
